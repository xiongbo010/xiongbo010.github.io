...
My research centres on machine learning with a special focus on relational and graph-structured data (e.g., social/biological networks and knowledge graphs). 
Specifically, I am developing geometric embedding models that faithfully model the discrete properties inherent in the graph-structured data. 
